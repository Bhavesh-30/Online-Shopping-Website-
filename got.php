...
<html>
<head>
	<title>Fruit Vegetable | ThinkGeek</title>
...
<div id="sidebar">
	<ul>
		...
		<li><a href="https://docs.google.com/forms/d/1tn-OvkSye1zavZqUo7cmtfESHwVwQBYoGpY34q9khzU/edit" target="_blank"><table><tr><td><img src="res/icons/request.png" /></td>
...
<div id="navbar">
	<ul>
		<li><a class="active" href="got.php">Fruit Vegetable</a></li>
		<li><a href="hp.php">Leaf Vegetable</a></li>
		<li><a href="hg.php">Fruits</a></li>		
	</ul>
</div>
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='a1' AND fandom='Fruit-Vegetable' ORDER BY id ASC");
if($results){ 
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='a2' AND fandom='Fruit-Vegetable' ORDER BY id ASC");
if($results){ 
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='a3' AND fandom='Fruit-Vegetable' ORDER BY id ASC");
if($results){ 
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
...
<footer class="container">
	<div class="row">	
		<p class="col-sm-6">
			&copy; Devolped By | Bhavesh Sudhir Jagtap<i style="color: #fd4b4b;">&nbsp; &#9829; &nbsp;</i>in India
		</p>

		<ul class="col-sm-6">
			<li class="col-sm-1">
				<a href="mailto:jagtapbhavesh7@gmail.com" target="_blank">
					<img src="res/social media/help.png">
				</a>
			</li>
			<li class="col-sm-1">
				<a href="https://twitter.com/Bhaveshjagtap7?s=08" target="_blank">
					<img src="res/social media/twitter.png">
				</a>
			</li>
			<li class="col-sm-1">
				<a href="https://www.facebook.com/profile.php?id=100006584086531" target="_blank">
			...
			<li class="col-sm-1">
				<a href="https://www.instagram.com/bhavesh_30/" target="_blank">
