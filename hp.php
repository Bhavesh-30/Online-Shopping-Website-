...
<html>
<head>
	<title>Leaf Vegetable | ThinkGeek</title>
...
<div id="navbar">
	<ul>
		<li><a href="got.php">Fruit Vegetable</a></li>
		<li><a class="active" href="hp.php">Leaf Vegetable</a></li>
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='a1' AND fandom='Leaf-Vegetable' ORDER BY id ASC");
if($results){ 
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='a2' AND fandom='Leaf-vegetable' ORDER BY id ASC");
if($results){ 
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='a3' AND fandom='Leaf-Vegetable' ORDER BY id ASC");
if($results){ 
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
